            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Welcome to Young Star Club</h3>
                    </div>
...
@section('content')
    ...
    <header id="header" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo me-auto"><a href="{{ route('index') }}">Young Star Club</a></h1>
            ...
            <div class="container-fluid" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img"
                        style='background-image: url("{{ asset('frontend_assets') }}/img/why-us.png");'
                    ...
                    @foreach ($members as $member)
                        <div class="col-lg-6 my-3" data-aos="zoom-in" data-aos-delay="100">
                            <div class="member d-flex align-items-start">
                                <div class="pic"><img
                                        src="{{ asset('uploads/member_photo') }}/{{ $member->member_photo }}"
                                ...
                                <div class="member-info">
                                    ...
                                    <p>Blood Group : <strong class="text-danger">{{ $member->blood_group }}</strong></p>
                                    <p>Birth Reg. / NID No : {{ $member->id_no }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
                    ...
                    <div class="col-lg-5 d-flex align-items-stretch">
                        <div class="info">
                            <div class="address">
                                ...
                                <h4>Location:</h4>
                                <p>Chalkbeltoil, Nandina, Jamalpur</p>
                            </div>

                            <div class="email">
                                <i class="bi bi-envelope"></i>
                                <h4>Email:</h4>
                                <p>youngstarclub26.05.2016@gmail.com</p>
                            </div>

                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d50428.24929415842!2d89.96650585764928!3d24.84923079787048!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37562a5115d3e2e5%3A0x3479e4dc7c57061!2sChalkbeltoyl!5e0!3m2!1sen!2sbd!4v1700332434074!5m2!1sen!2sbd"
